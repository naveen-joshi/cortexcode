...
DetectCSharpFramework = Callable[[str, Any, str], str | None]


def extract_csharp_with_framework(
    source: str,
    node: Any,
    ...
    detect_csharp_framework: DetectCSharpFramework,
) -> None:
    node_type = node.type
    ...
    if node_type in ("method_declaration", "local_function_statement"):
        ...
        if name:
            ...
            framework = detect_csharp_framework(name, node, source)
