...
DetectKotlinFramework = Callable[[str, Any, str], str | None]


def extract_kotlin_recursive(
    source: str,
    node: Any,
    ...
    detect_kotlin_framework: DetectKotlinFramework,
) -> None:
    node_type = node.type
    ...
    if node_type == "function_declaration":
        ...
        if name:
            ...
            framework = detect_kotlin_framework(name, node, source)
